...
const SelectInterest = ({ navigation, route }) => {
	...
	const handelContinue = () => {
		if (selectedInterests.length < 0) {
			Toast.show({
				type: 'error',
				text1: 'Selected some Interest!',
				text2: `You have not select any interest!`,
			});
			return;
		}
		...
		Toast.show({
			type: 'success',
			text1: 'Interests Selected!',
			text2: `You selected: ${selectedInterests.length} interests`,
		});
		navigation.navigate('IdealMatch', {
			...payloads,
	...
	return (
		<View style={styles.container}>
			...
			<Text style={styles.subtitle}>
				Select a few of your interests to match with users who have similar
				things in common.
			</Text>
			...
			{/* Continue Button */}
			<TouchableOpacity style={styles.continueButton} onPress={handelContinue}>
