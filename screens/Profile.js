...
import { convertDobToAge } from '../utils';
			...
			<View style={styles.profileSection}>
				...
				<View style={styles.userInfo}>
					<Text style={styles.userName}>
						{userData.name},
						{convertDobToAge(userData.dob || userData.createdAt)}
					</Text>
					<View style={styles.statusContainer}>
						<Text style={styles.statusText}>
							<AntDesign name="heart" color={colors.black} />{' '}
							{userData.bio ? userData.bio : 'Ready for a relationship'}
						</Text>
					</View>
				</View>
			</View>
				...
				<View style={styles.boostSectionContainer}>
					...
					>
						...
						<Text style={styles.boostText}>
							Boost your dating odds with an extra profile photo
						</Text>
								...
								<View style={styles.subscriptionItems}>
									...
									<View style={styles.planRow}>
										<Text style={styles.planText}>
											Bonus credits on credit purchases
										</Text>
